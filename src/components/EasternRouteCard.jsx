...
export default function EasternRouteCard() {
  const s = t.easternRouteCard
  return (
    <div
      style={{
        maxWidth: 380,
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', flex: 1 }}>
          <p style={{ fontFamily: MONO, fontSize: 14, color: ORANGE, fontWeight: 700, margin: '0 0 2px' }}>
            La L&iacute;nea
          </p>
          <p style={{ fontSize: 11, color: '#64748b', margin: 0, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
            {s.destLabel}
      ...
      >
        <p style={{ fontSize: 13, color: 'white', margin: 0, lineHeight: 1.6, fontStyle: 'italic' }}>
          {s.callout}{' '}
          <span style={{ color: ORANGE, fontWeight: 600 }}>{s.calloutHigh}</span>{' '}
          {s.calloutEnd}
        </p>
      </div>
    </div>
